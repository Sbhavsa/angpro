...
@Component({
  selector: 'app-homeclientter',
  imports: [CommonModule],
  templateUrl: './homeclientter.component.html',
  styleUrl: './homeclientter.component.css'
})
export class HomeclientterComponent {
